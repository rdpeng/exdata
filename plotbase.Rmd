...
```{r,fig.height=5,fig.width=5,fig.cap="Ozone levels in New York City"}
library(datasets)
...
```{r,fig.height=5,fig.width=5,fig.cap="Ozone levels by month in New York City",message=FALSE}
...
```{r,fig.height=5,fig.width=5,fig.cap="Scatterplot of wind and ozone in New York City"}
...
```{r,fig.height=5,fig.cap="Base plot with annotation"}
library(datasets)
...
```{r,fig.height=5,fig.cap="Base plot with multiple annotations"}
...
```{r,fig.height=5,fig.cap="Scatterplot with linear regresion line"}
...
```{r,fig.height=5,fig.width=12,fig.cap="Panel plot with two plots"}
par(mfrow = c(1, 2))
with(airquality, {
...
```{r,fig.height=4,fig.width=12,fig.cap="Panel plot with three plots"}
